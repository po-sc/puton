...
def read_a(reader: BinaryReader):
    ...
    a5 = []
    for i in range(5):
       a5.append(read_e(BinaryReader(reader.source, reader.read(Types.uint32))))
    ...
    for _ in range(a6_size):
        a6.append(e4_reader.read(Types.int32))
...
def read_c(reader: BinaryReader):
    ...
    for _ in range(c3_size):
        c3.append(c3_reader.read(Types.char))
    ...
    c8 = []
    for i in range(2):
        c8.append(reader.read(Types.unit16))
